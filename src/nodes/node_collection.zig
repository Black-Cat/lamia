...
pub const surfaces = [_]NodeType{
    ...
    @import("surfaces/dodecahedron.zig").Dodecahedron,
    @import("surfaces/dodecahedron_edges.zig").DodecahedronEdges,
    @import("surfaces/ellipsoid.zig").Ellipsoid,
    @import("surfaces/hexagonal_prism.zig").HexagonalPrism,
    @import("surfaces/icosahedron.zig").Icosahedron,
    @import("surfaces/icosahedron_edges.zig").IcosahedronEdges,
